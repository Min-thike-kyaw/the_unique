	...
	<div id="header" class="container">
		...
		<div id="menu">
			<ul>
				...
				<li class="{{Request::path() === 'authors' ? 'current_page_item' : ''}}"><a   href="/authors" accesskey="2" >Authors</a></li>
				<li class="{{Request::path() === 'articles' ? 'current_page_item' : ''}} "><a  href="/articles">Articles</a></li>
				<li class=" {{Request::path() === 'career' ? 'current_page_item' : ''}} "><a>Careers</a></li>
				<li class=" {{Request::path() === 'contact' ? 'current_page_item' : ''}}  "><a >Contact Us</a></li>
			</ul>
		</div>
	</div>
